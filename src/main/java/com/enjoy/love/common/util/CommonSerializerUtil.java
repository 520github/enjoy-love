...
public class CommonSerializerUtil {
	private final static CommonLogger serializerLogger = CommonLoggerFactory
			.getLogger(CommonSerializerUtil.class);
	...
	public static byte[] serialize(Object obj) throws IOException {
		...
		try {
			...
			LogUtil.error(e, serializerLogger,
					"Object convert to bytes array fail:object={0}", obj);
			throw e;
		} finally {
	...
	public static Object deSerialize(byte[] byteArray) throws IOException,
		...
		try {
			...
			LogUtil.error(e, serializerLogger,
					"bytes array convert to object fail:byteArray={0}",
					byteArray);
			throw e;
	...
	private static void closeOutputStream(ObjectOutputStream os,
		...
		if (os != null) {
			try {
				...
				LogUtil.error(e, serializerLogger,
						"close objectOutputStream fail:object={0}", os);
				throw e;
			}
		}
		if (bis != null) {
			try {
				...
				LogUtil.error(e, serializerLogger,
						"close byteArrayOutputStream fail:object={0}", os);
				throw e;
			}
		}
	}
	...
	private static void closeInputStream(ByteArrayInputStream bos,
		...
		if (bos != null) {
			try {
				...
				LogUtil.error(e, serializerLogger,
						"close objectInputStream fail:object={0}", bos);
				throw e;
			}
		}
		if (ois != null) {
			try {
				...
				LogUtil.error(e, serializerLogger,
						"close byteArrayInputStream fail:object={0}", ois);
				throw e;
			}
		}
	}
